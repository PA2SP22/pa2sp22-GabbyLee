 ...
 */
string ArrayBackwardsAsString(int array[], unsigned int
...
to_return = value *Factorial(value - 1);
}
return to_return;
}
...
to_return = Fibonacci(fib_value -1) + Fibonacci(fib_value - 2);
}
return to_return;
}
...
string ArrayBackwardsAsString(int array[],
